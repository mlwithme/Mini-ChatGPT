...
DB_URI = os.getenv(
    "DB_URI",
    "postgresql://db_name:your_password@your_host_ip:5432/mypg?sslmode=disable",
)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="LangChain create_agent ChatGPT demo with PostgreSQL memory"
    )
    ...
    parser.add_argument("--search_memory_limit", type=int, default=20)
